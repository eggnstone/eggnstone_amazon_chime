...
SWIFT_PROTOCOL("_TtP14AmazonChimeSDK21SegmentationProcessor_")
@protocol SegmentationProcessor
- (BOOL)initializeWithHeight:(NSInteger)height width:(NSInteger)width channels:(NSInteger)channels SWIFT_WARN_UNUSED_RESULT;
- (BOOL)predict SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)getModelState SWIFT_WARN_UNUSED_RESULT;
- (uint8_t * _Nonnull)getInputBuffer SWIFT_WARN_UNUSED_RESULT;
- (uint8_t * _Nonnull)getOutputBuffer SWIFT_WARN_UNUSED_RESULT;
@end
