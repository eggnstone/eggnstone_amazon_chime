...
The example works on Android emulators as far as showing the version of the SDK. Anything else will trigger an UnsatisfiedLinkError for libc++_shared.so.
